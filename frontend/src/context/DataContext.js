  ...
  const getTransactions = useCallback(() => {
    ...
    generatorOperations.forEach(op => {
      transactions.push({
        ...
        amount: op.spending_amount || op.total_amount || 0,
        total: (op.spending_amount || op.total_amount || 0) + (op.misc_expense || 0),
        misc: op.misc_expense || 0,
        spending_amount: op.spending_amount || op.total_amount || 0,
        misc_expense: op.misc_expense || 0,
    ...
    excavatorOperations.forEach(op => {
      transactions.push({
        ...
        amount: op.spending_amount || op.total_amount || 0,
        total: (op.spending_amount || op.total_amount || 0) + (op.misc_expense || 0) + (op.misc_expense_2 || 0),
        misc: (op.misc_expense || 0) + (op.misc_expense_2 || 0),
        spending_amount: op.spending_amount || op.total_amount || 0,
        misc_expense: op.misc_expense || 0,
        misc_expense_2: op.misc_expense_2 || 0,
        miscAmount: (op.misc_expense || 0) + (op.misc_expense_2 || 0),
        month: new Date(op.operation_date).toLocaleString('default', { month: 'long' }),
        year: new Date(op.operation_date).getFullYear().toString(),
      });
    });
    ...
    blastingMaterials.forEach(m => {
      ...
      transactions.push({
        ...
        amount: m.spending_amount || m.total_amount || 0,
        total: (m.spending_amount || m.total_amount || 0) + (m.misc_expense || 0),
        misc: m.misc_expense || 0,
        spending_amount: m.spending_amount || m.total_amount || 0,
        misc_expense: m.misc_expense || 0,
        misc_description: m.misc_description || '',
    ...
    plantMessExpenses.forEach(e => {
      transactions.push({
        ...
        amount: e.spending_amount || e.amount || 0,
        total: (e.spending_amount || e.amount || 0) + (e.misc_expense || 0),
        misc: e.misc_expense || 0,
        spending_amount: e.spending_amount || e.amount || 0,
        misc_expense: e.misc_expense || 0,
        misc_description: e.misc_description || '',
    ...
    dumperOperations.forEach(op => {
      ...
      transactions.push({
        ...
        amount: op.spending_amount || op.trip_amount || 0,
        total: (op.spending_amount || op.trip_amount || 0) + (op.misc_expense_2 || 0),
        misc: op.misc_expense_2 || 0,
        spending_amount: op.spending_amount || op.trip_amount || 0,
        fuel_amount: op.fuel_amount || 0,
        misc_expense_2: op.misc_expense_2 || 0,
    ...
    salaries.forEach(s => {
      ...
      transactions.push({
        ...
        amount: s.spending_amount || s.net_salary || 0,
        total: (s.spending_amount || s.net_salary || 0) + (s.misc_expense || 0),
        misc: s.misc_expense || 0,
        spending_amount: s.spending_amount || s.net_salary || 0,
        misc_expense: s.misc_expense || 0,
        misc_description: s.misc_description || '',
