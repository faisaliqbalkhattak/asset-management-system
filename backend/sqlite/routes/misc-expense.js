// =====================================================
// MISC EXPENSE GENERAL ROUTES
// =====================================================
// API routes for miscellaneous expenses (rent, doctor, etc.)
// Separate table with own entry point
// =====================================================

const express = require('express');
const router = express.Router();
const { MiscExpenseGeneralRepository } = require('../repositories');

const repo = new MiscExpenseGeneralRepository();
