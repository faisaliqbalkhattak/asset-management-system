...
// GENERATOR ROUTES
// =====================================================
// API routes for generator operations
// =====================================================

const express = require('express');
const router = express.Router();
const { GeneratorOperationRepository } = require('../repositories');

const repo = new GeneratorOperationRepository();
...
router.post('/', (req, res, next) => {
    try {
        ...
        if (!req.body.equipment_name) {
            return res.status(400).json({ 
                success: false, 
                error: 'equipment_name is required. Select a generator.' 
            });
        }
